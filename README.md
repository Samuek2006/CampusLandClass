# 🚀 CampusLand J1 – Repositorio de Clases y Proyectos
...
- [✍️ Autores y Colaboradores](#️-autores-y-colaboradores)
...
<details>
    <summary>📜 <strong>Reglas de Uso</strong></summary>

    - Este repositorio es **privado** y su acceso está limitado.
    - Los archivos deberán estar **bien documentados y organizados**.
    - Se recomienda seguir buenas prácticas de **nomenclatura y estructura de carpetas**.
</details>
...
**⭐ Si este repositorio te ayuda, recuerda dejar tu "star" (si es público en algún momento).**
