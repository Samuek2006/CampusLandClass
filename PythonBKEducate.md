...
A continuación, se describe la metodología a utilizar en el desarrollo del modulo: 

### **Sesiones Asincrónica ** 

Durante el proceso de aprendizaje el estudiante contará con 60 horas de clase con un experto el cual explicará el contenido temático de cada unidad académica. 

Las sesiones se realizarán por medio de la plataforma Microsoft Teams, serán grabadas y almacenadas en la plataforma LMS con el fín de que el estudiante pueda acceder a ellas en cualquier momento y así realizar una retroalimentación de lo trabajado durante cada una de las sesiones; las grabaciones estarán siempre disponibles a posterioridad. 

En cada sesión Asincrónica    el estudiante deberá registrar su asistencia en la plataforma LMS y así podrá llevar a cabo un autocontrol de su aprendizaje. 

## Contenido Curricular programación básica con Python: 

A continuación, se presenta el contenido curricular correspondiente al modulo con una duración de 7 semanas 

### Programación básica con python

| Unidad de Aprendizaje             | Contenido                                                    | Duración máxima (hras) | Tipo        |
| --------------------------------- | ------------------------------------------------------------ | ---------------------- | ----------- |
| 0. Algoritmia                     | ¿Qué es un Algoritmo?                                        |                        |             |
|                                   | ¿Qué es el Pseudocódigo?                                     |                        |             |
|                                   | Elementos Básicos del Pseudocódigo                           |                        |             |
|                                   |                                                              |                        |             |
| 1. Introducción a la Programación |                                                              | 1                      | Asincrónica |
...
|                                   | Test                                                         |                        |             |
| 2. Variables y tipos de datos     |                                                              | 1                      | Asincrónica |
|                                   | Variables y constantes                                       |                        |             |
|                                   | Tipos de datos básicos (Numéricos, cadenas y booleanos)      |                        |             |
|                                   | Conversión de tipos de datos o cast                          |                        |             |
|                                   | Test                                                         |                        |             |
| 3.Estructuras de control          |                                                              | 7                      | Asincrónica |
|                                   | Condiciones- If y Else                                       |                        |             |
|                                   | Declaración Match (Switch)                                   |                        |             |
|                                   | Bucle While                                                  |                        |             |
|                                   | Bucle For                                                    |                        |             |
...
|                                   | Listas                                                       | 11                     |             |
|                                   | Conceptos básicos                                            |                        | Asincrónica |
|                                   | Creación de listas                                           |                        |             |
|                                   | Manipulación de listas                                       |                        | Asincrónica |
...
|                                   | Lista de listas                                              |                        | Asincrónica |
|                                   | Ejercicio practico                                           |                        |             |
|                                   | **Diccionarios**                                             | 12                     |             |
|                                   | Conceptos básicos                                            |                        |             |
|                                   | Creación de diccionarios                                     |                        |             |
|                                   | Manipulación de diccionarios                                 |                        |             |
|                                   | Añadiendo elementos a un diccionario (función update)        |                        |             |
...
|                                   | Métodos de los sets                                          |                        |             |
|                                   | Test                                                         |                        |             |
| 7.Uso y manejo de funciones       | Conceptos básicos                                            | 5                      |             |
|                                   | Estructura de una Función Python                             |                        |             |
|                                   | Retornar múltiples valores desde una función                 |                        |             |
|                                   | Funciones y no procedimientos                                |                        |             |
|                                   | Parámetros especiales y argumentos de funciones              |                        |             |
|                                   | Parámetros args y kargs                                      |                        |             |
| 8.Persistencia de datos           |                                                              | 7                      |             |

# 📔Algoritmia

## ✅ MÓDULO 1: ¿Qué es un Algoritmo?

### 🎯 Objetivo:

Comprender qué es un algoritmo, sus propiedades y su importancia en la resolución de problemas.

### 🧠 Teoría:

Un **algoritmo** es una secuencia **ordenada**, **finita** y **no ambigua** de pasos que resuelven un problema. Es la base de toda programación.

### 🧩 Características:

- **Finito**: Tiene un inicio y un fin claros.
- **Ordenado**: Cada paso tiene una secuencia lógica.
...
>
> 1. Calentar agua.
> 2. Servir café en la taza.
> 3. Verter el agua caliente.
> 4. Revolver.
> 5. Listo.

## ✅ MÓDULO 2: Introducción al Pseudocódigo

### 🎯 Objetivo:

Aprender a expresar algoritmos mediante pseudocódigo claro y estructurado.

### 🧠 Teoría:

El **pseudocódigo** permite representar un algoritmo sin necesidad de programar. Usa estructuras comunes como `Inicio`, `Fin`, `Leer`, `Escribir`, `Si`, `Mientras`, `Para`, etc.
...
## ✅ MÓDULO 3: Variables y Operaciones (versión ampliada)

### 🎯 Objetivo:

Comprender qué son las variables, cómo declararlas correctamente, sus tipos y cómo se utilizan en operaciones.

------

### 🧠 ¿Qué es una variable?

Una **variable** es un espacio de memoria donde se guarda un valor que puede cambiar durante la ejecución del algoritmo. Cada variable tiene:
...
### 📌 Reglas para declarar variables en pseudocódigo

A continuación se presentan las **reglas más importantes** al declarar variables en pseudocódigo:

| Regla                                                | Descripción                                               | Ejemplo                          |
| ---------------------------------------------------- | --------------------------------------------------------- | -------------------------------- |
| 1. **Debe declararse antes de usarse**               | Toda variable debe definirse al inicio del algoritmo.     | `Entero edad`                    |
| 2. **Debe tener un tipo de dato definido**           | Indica si almacenará texto, números enteros, reales, etc. | `Real promedio`                  |
| 3. **El nombre debe ser claro y representativo**     | El nombre debe indicar qué almacena.                      | `Cadena nombreCliente`           |
| 4. **No puede comenzar con un número**               | Los nombres válidos inician con una letra.                | ✅ `nota1` ❌ `1nota`              |
| 5. **No debe tener espacios ni símbolos especiales** | Usa guiones bajos o camelCase si es necesario.            | ✅ `totalVentas` ❌ `total ventas` |
| 6. **No usar palabras reservadas**                   | Evita palabras como `Inicio`, `Fin`, `Si`, etc.           | ❌ `Para`, `Leer`                 |
...
| Real     | Números con decimales          | 3.14, -1.5       |
...
### 🧪 Ejemplo de declaración de variables y uso:
...
## 📘 Sección de práctica guiada: Declaración y uso de variables

### ✍️ **Actividad 1: Declaración según requisitos**

A continuación se presenta una tabla con descripciones. Declara una variable adecuada para cada caso, siguiendo las reglas de nombrado, tipo de dato y claridad.

| Descripción                               | Nombre sugerido   | Tipo de dato | Declaración en pseudocódigo |
| ----------------------------------------- | ----------------- | ------------ | --------------------------- |
...
| Si un usuario ha iniciado sesión (Sí/No)  | sesionActiva      | Booleano     | `Booleano sesionActiva`     |
...
> ✅ **Tarea:** Completa la tabla con tus propios nombres, tipos y declaraciones para las siguientes situaciones:
>
> - Velocidad de un auto en km/h.
> - El título de un libro.
> - Resultado de una operación matemática.
> - Estado de aprobación de un examen.

------

### ✍️ **Actividad 2: Escribe un algoritmo**

> Escribe un algoritmo en pseudocódigo que declare:
>
...
## 📘 Sección de corrección de errores comunes

### 🧩 **Actividad 3: Encuentra y corrige los errores**

A continuación se presentan fragmentos de pseudocódigo con errores en la declaración y uso de variables. Encuentra y corrige los errores:
...
Inicio
    ...
    Leer nombre cliente
    Leer 1precio
    TotalCompra ← 1precio * 2
    Escribir "El total es: ", totalcompra
Fin
```

#### ✅ Espacio para código corregido:
...
Aplicar decisiones lógicas dentro del pseudocódigo.

### 🧠 Teoría:

Las estructuras **condicionales** permiten ejecutar instrucciones si se cumple una **condición**.
...
## ✅ MÓDULO 5: Estructuras Repetitivas (Ciclos)

### 🎯 Objetivo:

Usar ciclos para repetir bloques de código.

### 🧠 Teoría:

Los **ciclos** permiten ejecutar un conjunto de instrucciones **múltiples veces**, de forma controlada.
...
Se usa cuando **sí sabes cuántas veces repetirás**.
...
### 🔍 Ejemplo 2 (leer hasta número negativo):
...
## 📘 MÓDULO 6: Tipos de Lenguajes de Programación

### 🎯 Objetivo:

Comprender los distintos tipos de lenguajes de programación, su clasificación y usos, para reconocer cuál es más adecuado según el contexto de desarrollo.

------

### 🧠 ¿Qué es un lenguaje de programación?

Es un sistema de notación formal diseñado para escribir instrucciones que una **computadora puede interpretar y ejecutar**. Es la forma en que los humanos se comunican con las máquinas.

------

### 🧩 Clasificación general

Los lenguajes de programación se pueden clasificar según **su nivel de abstracción**, **su paradigma** y **su propósito**.
...
| ----------------------- | ------------------------------------------------------------ | ------------ |
| Lenguaje de bajo nivel  | Cercano al hardware, difícil para humanos, rápido y eficiente | Ensamblador  |
| Lenguaje de medio nivel | Mezcla instrucciones de hardware con abstracción (más fácil que ensamblador) | C            |
| Lenguaje de alto nivel  | Fácil de leer y escribir para humanos. Independiente del hardware | Python, Java |
...
| ------------------- | ------------------------------------------------------------ | ---------------------- |
| Imperativo          | Indica **cómo se hace** paso a paso                          | C, Pascal, Python      |
...
| Lógico              | Se basa en reglas y hechos para resolver problemas           | Prolog                 |
| Declarativo         | Indica **qué se quiere** sin detallar cómo                   | SQL, HTML              |
...
| --------------------------------- | ----------------------------- | ------------------------------------------------------ |
| Lenguajes de propósito general    | Se pueden usar para casi todo | Python, Java, C#                                       |
| Lenguajes de propósito específico | Usados para tareas concretas  | SQL (bases de datos), R (estadística), VHDL (hardware) |
...
| Lenguaje | Nivel | Paradigma           | Uso típico                     |
| -------- | ----- | ------------------- | ------------------------------ |
...
| Prolog   | Alto  | Lógico              | Inteligencia artificial        |
...
Una **función** es un bloque de código reutilizable que realiza una tarea específica. Permite **organizar el código**, **evitar repeticiones** y **mejorar la legibilidad**.

## 🛠️ Tipos de funciones en Python

### 🔹 A. Funciones definidas por el lenguaje (built-in functions)
...
📚 Referencia: [Built-in Functions — Python Docs](https://docs.python.org/3/library/functions.html)
...
#### `divmod()`: División y módulo al mismo tiempo

```
print(divmod(10, 3))  # (3, 1) → cociente y residuo
```

------

### 🧮 2. Funciones para colecciones
...
### 🧠 6. Funciones lógicas y de comparación
...
### 🧰 7. Funciones para programación funcional

#### `map()`: Aplica una función a una colección
...
#### `filter()`: Filtra elementos con una condición
...
#### `zip()`: Une elementos por posición
...
### 🔹 B. Funciones definidas por el usuario (user-defined functions)
...
| Cuerpo     | Código que se ejecuta cuando se llama la función |
...
### ¿Cómo se puede especificar el tipo de dato que retorna una función en Python?

En Python, desde la versión 3.5 en adelante, es posible **anotar el tipo de retorno** de una función usando **type hints** (anotaciones de tipo). Esto permite indicar de manera explícita qué tipo de dato se espera que devuelva una función, lo cual mejora la legibilidad del código y ayuda a detectar errores antes de tiempo cuando se usan herramientas como `mypy`.

### 🧠 Sintaxis general

```
def nombre_funcion(parámetros) -> TipoDeDatoEsperado:
    return resultado
```

El operador `->` se utiliza para declarar el tipo del valor que la función devuelve.

------

### ✅ Ejemplos prácticos

#### 1. Función que retorna un entero
...
Aquí se especifica que los parámetros `a` y `b` son enteros y que la función devolverá un entero (`int`).

------

#### 2. Función que retorna una cadena
...
#### 3. Función que retorna una lista de enteros
...
> 💡 En versiones anteriores a Python 3.9, se debe importar `List` desde el módulo `typing`:
...
#### 4. Función que no retorna ningún valor (`None`)
...
El tipo `None` indica que la función no devuelve ningún valor útil.

------

#### 5. Función que puede devolver un valor o `None` (`Optional`)
...
Aquí se aclara que la función puede retornar un número entero o `None`, dependiendo de si encuentra el valor.

------

#### 6. Función que retorna múltiples valores en una tupla
